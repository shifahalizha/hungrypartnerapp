...
import com.example.hungrypartner.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    private fun uploadData(){
        ...
        val dataClass2 = DataClass2(title, desc, priority, imageURL)
        val currentDate = DateFormat.getDateTimeInstance().format(Calendar.getInstance().time)

        FirebaseDatabase.getInstance().getReference("hungrypartner").child(currentDate)
            .setValue(dataClass2).addOnCompleteListener{ task ->
